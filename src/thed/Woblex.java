...
/**
 * A 2d vertex/point that 'wobbles'.<br>
 * getX() and getY() return values that oscillate depending on the seed given (Eg. the current milliseconds?)
 *
...
public class Woblex {
    ...
    public Woblex(double x, double y) {
        this.x = x;
        this.y = y;
    }
